...
//                    i++;
//                    len = unsignedLongToStr(va_arg(vl, unsigned long), temp_buff, 10, strToInt(a_buff, a_len), 0,
//                                            filler);
//                    for (uint32_t k = 0; k < len; k++)
//                        buff[count++] = temp_buff[k];
//                    break;
...
//                    i += 2;
//                    len = unsignedLongLongToStr(va_arg(vl, unsigned long long), temp_buff, 10, strToInt(a_buff, a_len),
//                                                0, filler);
//                    for (uint32_t k = 0; k < len; k++)
//                        buff[count++] = temp_buff[k];
//                    break;
...
//                    i += 2;
//                    len = unsignedLongLongToStr(va_arg(vl, unsigned long long), temp_buff, 16, strToInt(a_buff, a_len),
//                                                0, filler);
//                    for (uint32_t k = 0; k < len; k++)
//                        buff[count++] = temp_buff[k];
//                    break;
...
//                    break;
//                } else if (format[i] == 'f') {
//                    len = doubleToStr(va_arg(vl, double), temp_buff, b_len == 0 ? 6 : strToInt(b_buff, b_len),
//                                      strToInt(a_buff, a_len), 0, filler);
//                    for (uint32_t k = 0; k < len; k++)
//                        buff[count++] = temp_buff[k];
//                    break;
//                } else if (format[i] == 'b') {
